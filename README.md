...
1.  [Configuração do Ambiente](https://www.google.com/search?q=%231-configura%C3%A7%C3%A3o-do-ambiente-back-end)
2.  [Criar Projeto Spring](https://www.google.com/search?q=%232-criar-projeto-spring)
3.  [Configuração VS Code](https://www.google.com/search?q=%233-configura%C3%A7%C3%A3o-vscode)
4.  [Implementação do Código](https://www.google.com/search?q=%234-implementa%C3%A7%C3%A3o-do-c%C3%B3digo)
5.  [Rodar o Projeto](https://www.google.com/search?q=%235-rodar-o-projeto)
6.  [Extra (DBeaver)](https://www.google.com/search?q=%236-extra)

### Versão Windows

1.  [Configuração do Ambiente](https://www.google.com/search?q=%231-configura%C3%A7%C3%A3o-do-ambiente-back-end-1)
2.  [Criar Projeto Spring](https://www.google.com/search?q=%232-criar-projeto-spring-1)
3.  [Configuração VS Code](https://www.google.com/search?q=%233-configura%C3%A7%C3%A3o-vs-code)
4.  [Implementação do Código](https://www.google.com/search?q=%234-implementa%C3%A7%C3%A3o-do-c%C3%B3digo-1)
5.  [Rodar o Projeto](https://www.google.com/search?q=%235-rodar-o-projeto-1)
6.  [Extra (DBeaver/HeidiSQL)](https://www.google.com/search?q=%236-extra-1)
...
        ALTER USER 'root'@'localhost' IDENTIFIED VIA mysql\_native\_password USING PASSWORD('');
...
    ` powershell     .\mvnw.cmd clean spring-boot:run      `
